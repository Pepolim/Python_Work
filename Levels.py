...
class Level6:
    def __init__(self, display, gameStateManager):
        ...
        # Add this to your level class attributes (in __init__)
        self.size_changer = pygame.Rect(400, main.SCREEN_HEIGHT - GROUND_HEIGHT - 20, 100, 20)  # Platform that changes size
